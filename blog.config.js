...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '6642dbd738c8434487b8b22ef7c62737',
  //NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '60659c827d554cb695fca641d058f5d4',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yaya', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '长期专注于“人体表皮细胞与海洋生物鳞片摩擦”相关的研究', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'yaya.run', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，个人', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1307317886@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/DuckDuck88', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2022155204号-1', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'DuckDuck88/blogComment', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOJgOAKg', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
      process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOJgOAKs4CWVzn', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '%5Bbaidu_id%5D', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '%5Bcnzz_id%5D', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ...
  NOTION_PROPERTY_NAME: {
    ...
    status_publish: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_PUBLISH || '发表', // 当status状态值与此相同时为发布，可以为中文
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/duck.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'YaYas Home', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '鸭鸭的个人博客', // 站点描述，被notion中的页面描述覆盖
